...
def main():
    ...
    with open('Data/ProcessedData_Truncated/df_constant_current.pkl', 'wb') as f:
        pickle.dump(df_constant_current, f)
    with open('Data/ProcessedData_Truncated/df_periodic.pkl', 'wb') as f:
        pickle.dump(df_periodic, f)
    with open('Data/ProcessedData_Truncated/df_synthetic.pkl', 'wb') as f:
        pickle.dump(df_synthetic, f)
    with open('Data/ProcessedData_Truncated/df_real_driving.pkl', 'wb') as f:
